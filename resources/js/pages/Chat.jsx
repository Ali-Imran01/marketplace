...
const Chat = () => {
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
                ...
                // Dynamically set receiver if missing
                if (!receiverId) {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8 h-[calc(100vh-160px)] flex flex-col">
            <div className="brand-card flex-grow flex flex-col overflow-hidden">
                <div className="px-8 py-6 border-b bg-white flex justify-between items-center relative">
                ...
                <form onSubmit={handleSend} className="p-6 bg-white border-t flex space-x-3 items-center">
                    <input
                        type="text"
                        className="flex-grow px-6 py-4 rounded-2xl bg-gray-50 focus:bg-white focus:ring-4 focus:ring-brand-500/10 outline-none transition-all font-semibold text-gray-900 border-none"
                    ...
                    <button
                        type="submit"
                        className="bg-brand-600 text-white px-8 py-4 rounded-2xl font-black shadow-xl shadow-brand-600/20 hover:bg-brand-700 transition-all active:scale-95 flex items-center gap-2 group"
                    >
                        <span>Send</span>
